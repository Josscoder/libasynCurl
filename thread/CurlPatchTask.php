...
class CurlPatchTask extends CurlTask
{
    /** @var string */
    ...
    {
        $this->setResult(self::patchURL($this->page, $this->args, $this->timeout, $this->getHeaders()));
    }

    /**
     * PATCHs data to a URL
     ...
     */
    private static function patchURL(string $page, $args, int $timeout = 10, array $extraHeaders = [], &$err = null): ?InternetRequestResult
    {
        try {
